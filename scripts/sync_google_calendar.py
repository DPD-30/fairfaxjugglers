...
def meeting_exists(service, calendar_id, meeting_date, location, address):
    ...
    start_str = start_of_day_utc.astimezone(timezone.utc).isoformat(timespec='seconds') + 'Z'
    end_str = end_of_day_utc.astimezone(timezone.utc).isoformat(timespec='seconds') + 'Z'
